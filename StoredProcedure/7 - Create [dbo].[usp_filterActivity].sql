/****** Object:  StoredProcedure [dbo].[usp_filterActivity]    Script Date: 28/05/2024 10:58:26 ******/
DROP PROCEDURE IF EXISTS [dbo].[usp_filterActivity]
GO
...
CREATE procedure [dbo].[usp_filterActivity]
